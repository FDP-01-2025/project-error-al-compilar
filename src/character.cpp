...
Character naruto; 
    ...
    naruto.abilities[3] = {"Hinata's kiss", -20, 1.0f};
    return naruto;
}
...
sasuke.abilities[3] = {"Susano'o", -15, 1.0f};  // Cura
return sasuke;
}
...
neji.abilities[0] = {"Eight Trigrams Sixty-Four Palms", 25, 0.8f};
neji.abilities[1] = {"Gentle Fist", 20, 0.9f};
neji.abilities[2] = {"Rotation Defense", 10, 1.0f};  
neji.abilities[3] = {"Byakugan Focus", -20, 1.0f};  // Cura
return neji;
}
...
lee.name = "Rock Lee"; 
 lee.health = MAX_HEALTH;
    ...
    lee.abilities[1] = {"Primary Lotus", 35, 0.6f};
    lee.abilities[2] = {"Drunken Fist", 25, 0.8f};
    lee.abilities[3] = {"Recovery Push-ups", -20, 1.0f};  // Cura
    return lee;
}
...
gaara.abilities[1] = {"Sand Shield", 10, 1.0f};  
gaara.abilities[2] = {"Shukaku’s Rage", 40, 0.5f};
gaara.abilities[3] = {"Sand Healing", -20, 1.0f};  // Cura
return gaara;
}
